...
import (
	...
	clientrest "github.com/eligion/cosmos-sdk/client/rest"
	...
	genutilrest "github.com/eligion/cosmos-sdk/x/genutil/client/rest"
)
...
func QueryAccountRequestHandlerFn(storeName string, clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			...
			// Ref: https://github.com/eligion/cosmos-sdk/issues/4923
