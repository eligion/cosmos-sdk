...
- **[SDK API Reference](https://godoc.org/github.com/eligion/cosmos-sdk)**: Godocs of the Cosmos SDK.
...
See the [DOCS_README.md](https://github.com/eligion/cosmos-sdk/blob/master/docs/DOCS_README.md) for details of the build process and
