...
delegated stake
- "sub-keys" functionality, as originally proposed in [\#4480](https://github.com/eligion/cosmos-sdk/issues/4480) which
...
- B-Harvest subkeys spec: https://github.com/eligion/cosmos-sdk/issues/4480
